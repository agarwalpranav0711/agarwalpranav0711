...
Advanced React concepts, backend development, contributing more effectively to open source, and understanding how real-world production apps are built.

🌱 I’m currently learning  
JavaScript deeply, React, Git & GitHub, Data Structures & Algorithms, Python basics, n8n automation, AI tools (agents & workflows), APIs, and better UI/UX practices.

💬 Ask me about  
React basics, JavaScript, GitHub projects, using AI tools for learning, building beginner projects, n8n workflows, productivity systems, and starting with open source.

⚡ Fun fact  
I learn best by building projects slightly above my level, breaking things, and fixing them again 😄
...
[![](https://visitcount.itsvg.in/api?id=agarwalpranav0711&icon=0&color=0)](https://visitcount.itsvg.in)
